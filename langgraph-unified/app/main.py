...
setup_logging(
    service_name="langgraph-unified",
...
app = FastAPI(
    lifespan=lifespan,
    title="LangGraph Unified RAG",
    version="1.0.0",
    description="All LangGraph RAG patterns in a single service",
    docs_url="/api/docs",
    redoc_url="/api/redoc",
...
async def root_health() -> dict:
    return {"status": "UP", "service": "langgraph-unified"}
