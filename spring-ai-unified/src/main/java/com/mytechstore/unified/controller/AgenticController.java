...
import com.mytechstore.unified.service.AgenticPipelineService;
...
public class AgenticController {
    ...
    public AgenticController(AgenticPipelineService pipelineService) {
    ...
    public ResponseEntity<AgenticRagResponse> ask(@Valid @RequestBody RagRequest request) {
