...
import com.mytechstore.unified.service.StructuredPipelineService;
...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("/hierarchical/api")
public class HierarchicalController {

    private final StructuredPipelineService pipelineService;

    public HierarchicalController(StructuredPipelineService pipelineService) {
    ...
    public ResponseEntity<HierarchicalRagResponse> ask(@Valid @RequestBody RagRequest request) {
