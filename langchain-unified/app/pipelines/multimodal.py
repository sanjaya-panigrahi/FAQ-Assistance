...
class MultimodalPipeline:
    ...
    def ask(self, question: str, image_description: str, customer_id: str | None = None) -> VisionRagResponse:
        ...
        cached = response_cache.get("langchain-multimodal", tenant, f"{question}|{image_description}")
        if cached:
        ...
        response_cache.put("langchain-multimodal", tenant, f"{question}|{image_description}", response.model_dump())
        return response
